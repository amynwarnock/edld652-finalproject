...
```{r load-datasets, eval=FALSE, include=FALSE}
...
#Not sure about how parse_number works on interval data & code that has letter and number. I've been avoiding using parse number because of this reason. 

#math_sc$math_pctabove <- sub(".*-(.*)", "\\1", math_sc$math_pctabove)  This is what I used to get the upper end interval. 
...
ggplot(data = dat2, aes(geometry = geometry, 
	...
	labs(title = "Mean percentage of students that scored at or above proficient",
			 ...
			 caption = "Source: U.S. Department of Education") +
	theme_void()
#This is very brilliant way to compare across states!
```
...
#Wow! I did not know that V33 is the number of students in the district! Our group had to combine membership data and calculated # of students. That's good to know! Lesson learned!
```
...
#For total spending do you think it is important to adjust for state cost of living for more objective comparison? Because total spending includes salary for teachers and staff. 
```
...
#Great plot! Never seen one like this! I learned a lot from your works!
```
...
#This is very informative plot, however, the small label makes it hard to read and compare. 
```
